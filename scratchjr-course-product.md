...
- Start with an offline MVP, then translate what consistently worked into a modular structure that could later be delivered online.  
...
## 5. Classroom Course Design (Offline MVP)
...
- Simple checklists of skills for each unit (for example “open/close the app”, “recognise the stage”, “can run a script”).  
